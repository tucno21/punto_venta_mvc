            ...
            <div class="row align-items-center">
                <div class="col d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Formulario Notas de crédito o Débito</h5>
                        <input id="idVenta" type="hidden" value="<?= $id ?>">
                        <input id="urlIdVenta" type="hidden" data-url="<?= route('notaCDs.venta') ?>">
                        <input id="urlCreate" type="hidden" data-url="<?= route('notaCDs.create') ?>">
                        <input id="urlTipoComprobante" type="hidden" data-url="<?= route('notaCDs.tipocomprobante') ?>">
                        ...
                        <input id="urlTipoComprobante" type="hidden" data-url="<?= route('notaCDs.tipocomprobante') ?>">
                        <input id="urlSerieCorrelativo" type="hidden" data-url="<?= route('notaCDs.serieCorrelativo') ?>">
                        <input id="urlTipoNota" type="hidden" data-url="<?= route('notaCDs.tiponota') ?>">
                        <input id="urlBuscarVenta" type="hidden" data-url="<?= route('notaCDs.BuscarVenta') ?>">
                        <input id="urlIndexNotas" type="hidden" data-url="<?= route('notaCDs.index') ?>">
                    </div>
                    <div class="">
                        <a href="<?= route('notaCDs.index') ?>" class="btn btn-primary btn-sm">Volver</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-2">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-1">
                            <label for="inputBuscarComprobante" class="form-label m-0">Buscar Comprobante</label>
                            <input type="text" class="form-control" id="inputBuscarComprobante">
                        </div>
                        <div class="col-md-3 mb-1">
                            <label for="inputComprobante" class="form-label m-0">Comprobante</label>
                            <input type="text" class="form-control" id="inputComprobante" readOnly disabled>
                        </div>
                        <div class="col-md-4 mb-1">
                            <label for="inputCliente" class="form-label m-0">Cliente</label>
                            <input type="text" class="form-control" id="inputCliente" readOnly disabled>
                        </div>
                        <div class=" col-md-2 mb-1">
                            <label for="inputFechaVenta" class="form-label m-0">Fecha Venta</label>
                            <input type="date" class="form-control" id="inputFechaVenta" readOnly disabled>
                            <input type="hidden" id="inputTipoDocumentoReferencia">
                            <input type="hidden" id="inputSerieReferencia">
                            <input type="hidden" id="inputCorrelativoReferencia">
                        </div>
                    </div>
                    <!-- comprobantes -->
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-1">
                            <label for="inputTipoNota" class="form-label m-0">Tipo Nota</label>
                            <select class="form-select" id="inputTipoNota"></select>
                        </div>
                        <div class="col-md-3 mb-1">
                            <label for="inputDescripcion" class="form-label m-0">Descripción</label>
                            <input type="text" class="form-control" id="inputDescripcion">
                        </div>
                        <div class=" col-md-2 mb-1">
                            <label for="inputFechaNota" class="form-label m-0">Fecha</label>
                            <input type="date" class="form-control" value="<?= date('Y-m-d') ?>" readonly disabled>
                            <input type="hidden" id="inputFechaNota" value="<?= date('Y-m-d H:i:s') ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="row">
                                <div class="col-5" id="condicion_Pago"></div>
                                <div class="col-5" id="cantidadCuotas"></div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="text-center mt-2">
                                ...
                                <button class="btn btn-dark" type="button" id="btnEnviarNotas">Completar</button>
                            </div>
                        </div>
                    </div>
                </div>
