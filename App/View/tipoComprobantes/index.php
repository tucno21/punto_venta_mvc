...
$linksScript2 = [
    base_url . '/assets/js/factura/tipoComprobantes.js',
];
?>
            ...
            <div class="row align-items-center">
                <div class="col d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Panel de Tipos de Comprobantes</h5>
                        <input id="urlDataTable" type="hidden" data-url="<?= route('tipoComprobantes.dataTable') ?>">
                        <input id="urlCreate" type="hidden" data-url="<?= route('tipoComprobantes.create') ?>">
                        <input id="urlEdit" type="hidden" data-url="<?= route('tipoComprobantes.edit') ?>">
                        <input id="urlStatus" type="hidden" data-url="<?= route('tipoComprobantes.status') ?>">
                        <input id="urlDestroy" type="hidden" data-url="<?= route('tipoComprobantes.destroy') ?>">
                    </div>
                    <div class="">
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header p-2">
                    <h5>Lista de Tipos de Comprobantes</h5>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title h4" id="modalLabel">Formulario Tipo de Comprobante</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6  mt-3">
                        <label class="form-label mb-1">Ver en:</label>
                        <div class="input-group">
                            <span class="input-group-text"><i class="bi bi-list-stars"></i></span>
                            <input name="para" type="text" class="form-control" id="inputPara">
                        </div>
                    </div>
