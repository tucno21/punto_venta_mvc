...
class GeneradorXML
{
   //CREAR EL XML PARA FACTURA Y BOLETA
   public function CrearXMLFactura($rutaXML, $emisor, $cliente, $comprobante, $detalle, $cuotas = null)
   {
...
<Invoice xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2">
   ...
   <cac:AccountingCustomerParty>
      <cac:Party>
         <cac:PartyIdentification>
            <cbc:ID schemeID="' . $cliente['tipodoc'] . '">' . $cliente['dniruc'] . '</cbc:ID>
         </cac:PartyIdentification>
         <cac:PartyLegalEntity>
   ...
   <cac:PaymentTerms>
      <cbc:ID>FormaPago</cbc:ID>
      <cbc:PaymentMeansID>' . $comprobante['forma_pago'] . '</cbc:PaymentMeansID>
      <cbc:Amount currencyID="PEN">' . $comprobante['total'] . '</cbc:Amount>
   </cac:PaymentTerms>';
   ...
   <cac:TaxTotal>
      ...
      if ($comprobante['op_exoneradas'] > 0) {
         $xml .= '
      <cac:TaxSubtotal>
         <cbc:TaxableAmount currencyID="' . $comprobante['moneda'] . '">' . $comprobante['op_exoneradas'] . '</cbc:TaxableAmount>
      ...
      if ($comprobante['op_gratuitas'] > 0) {
         $xml .= '
      <cac:TaxSubtotal>
         <cbc:TaxableAmount currencyID="' . $comprobante['moneda'] . '">' . $comprobante['op_gratuitas'] . '</cbc:TaxableAmount>
         <cbc:TaxAmount currencyID="' . $comprobante['moneda'] . '">0.00</cbc:TaxAmount>
         <cac:TaxCategory>
            <cbc:ID schemeID="UN/ECE 5305" schemeName="Tax Category Identifier" schemeAgencyName="United Nations Economic Commission for Europe">E</cbc:ID>
            <cac:TaxScheme>
      ...
      $total_antes_de_impuestos = $comprobante['op_gravadas'] + $comprobante['op_exoneradas'] + $comprobante['op_inafectas'];
   ...
   public function CrearXMLNotaCredito($rutaXML, $emisor, $cliente, $comprobante, $detalle, $cuotas = null)
   {
      $doc = new DOMDocument();
...
<CreditNote xmlns="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2">
   ...
   <cac:AccountingCustomerParty>
      ...
      if ($cuotas != null && $comprobante['codmotivo'] == '13') {
         $totalCuota = 0;
         foreach ($cuotas as $value) {
            $totalCuota += $value['monto'];
         }
         // dd($totalCuota);
         $xml .= '
   <cac:PaymentTerms>
      <cbc:ID>FormaPago</cbc:ID>
      <cbc:PaymentMeansID>' . $comprobante['forma_pago'] . '</cbc:PaymentMeansID>
      <cbc:Amount currencyID="PEN">' . $totalCuota . '</cbc:Amount>
   </cac:PaymentTerms>';
   ...
   public function CrearXMLNotaDebito($rutaXML, $emisor, $cliente, $comprobante, $detalle)
   {
...
<DebitNote xmlns="urn:oasis:names:specification:ubl:schema:xsd:DebitNote-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2">
   ...
   public function CrearXMLResumenDocumentos($emisor, $cabecera, $detalle, $rutaXML)
   {
      $doc = new DOMDocument();
      $doc->formatOutput = false;
      $doc->preserveWhiteSpace = true;
   ...
   public function CrearXmlBajaDocumentos($emisor, $cabecera, $detalle, $rutaXML)
   {
      $doc = new DOMDocument();
      $doc->formatOutput = false;
      $doc->preserveWhiteSpace = true;
