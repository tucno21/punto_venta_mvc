            ...
            <div class="row align-items-center">
                <div class="col d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Formulario Ventas</h5>
                        <input id="urlCreate" type="hidden" data-url="<?= route('ventas.create') ?>">
                        <input id="urlTipoComprobante" type="hidden" data-url="<?= route('ventas.tipocomprobante') ?>">
                        <input id="urlCorrelativo" type="hidden" data-url="<?= route('ventas.serieCorrelativo') ?>">
                        <input id="urlMonedas" type="hidden" data-url="<?= route('ventas.monedas') ?>">
                    ...
                    <div class="">
                        <a href="<?= route('ventas.index') ?>" class="btn btn-primary btn-sm">Volver</a>
                    </div>
                </div>
            </div>
        </div>
