...
$linksScript2 = [
    base_url . '/assets/js/factura/monedas.js',
];
?>
            ...
            <div class="row align-items-center">
                <div class="col d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Panel de Monedas</h5>
                        <input id="urlDataTable" type="hidden" data-url="<?= route('monedas.dataTable') ?>">
                        <input id="urlCreate" type="hidden" data-url="<?= route('monedas.create') ?>">
                        <input id="urlEdit" type="hidden" data-url="<?= route('monedas.edit') ?>">
                        <input id="urlStatus" type="hidden" data-url="<?= route('monedas.status') ?>">
                        <input id="urlDestroy" type="hidden" data-url="<?= route('monedas.destroy') ?>">
                    </div>
                    <div class="">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title h4" id="modalLabel">Formulario Moneda</h5>
