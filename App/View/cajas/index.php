            ...
            <div class="row align-items-center">
                <div class="col d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Panel de Cajas</h5>
                        <input id="urlDataTable" type="hidden" data-url="<?= route('cajas.dataTable') ?>">
                        <input id="urlCreate" type="hidden" data-url="<?= route('cajas.create') ?>">
                        <input id="urlEdit" type="hidden" data-url="<?= route('cajas.edit') ?>">
                        <input id="urlStatus" type="hidden" data-url="<?= route('cajas.status') ?>">
                        <input id="urlDestroy" type="hidden" data-url="<?= route('cajas.destroy') ?>">
                    </div>
                    <div class="">
                        <button id="btnCrear" type="button" class="btn btn-primary btn-sm">Registrar Caja</button>
                    </div>
                </div>
            </div>
        </div>
