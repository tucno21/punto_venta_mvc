            ...
            <div class="row align-items-center">
                <div class="col d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <div class="page-header-title">
                        ...
                        <input id="urlCreate" type="hidden" data-url="<?= route('cotizaciones.create') ?>">
                        <input id="urlTipoComprobante" type="hidden" data-url="<?= route('cotizaciones.tipocomprobante') ?>">
                        <input id="urlCorrelativo" type="hidden" data-url="<?= route('cotizaciones.serieCorrelativo') ?>">
                        <input id="urlMonedas" type="hidden" data-url="<?= route('cotizaciones.monedas') ?>">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="row mt-2" id="cuotasContainer">
                                <!-- crear select de tiempo de duracion -->
                                <div class="col-8">
                                </div>
                                <div class="col-4">
                                    <label for="inputTiempoCotizacion" class="form-label m-0">Tiempo de Oferta</label>
                                    <select class="form-select" id="inputTiempoCotizacion">
